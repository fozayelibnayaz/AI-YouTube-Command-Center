...
import { LayoutDashboard, Brain, Tv, MessageCircle, Menu, X, Home } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-950">
      ...
      <header className="lg:hidden sticky top-0 z-50 bg-gray-900/95 backdrop-blur-md border-b border-white/5 px-4 py-3 flex items-center justify-between">
        ...
        <button onClick={() => setOpen(!open)} className="p-2 text-white rounded-lg hover:bg-white/10 transition-colors" aria-label="Toggle menu">
      ...
      {/* Sidebar - works for both mobile drawer and desktop */}
